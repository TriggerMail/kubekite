module github.com/webflow-archive/kubekite

go 1.16

require (
	github.com/buildkite/go-buildkite v2.1.0+incompatible
	...
	github.com/webflow/kubekite v0.0.0-20180730211035-75d53c4d3838
